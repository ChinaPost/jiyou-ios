...
@implementation DropDownConfirmOrderForm
...

{
    ...
    NSString *msg=((DropDownRowConfirm*)tableArray[indexPath.row]).rowMsg;
    NSString *price=((DropDownRowConfirm*)tableArray[indexPath.row]).price;
    
    if(price==nil)
        price=@"";
    
    cell.textLabel.text =[NSString stringWithFormat:@"%@      %@",msg,price];
    cell.textLabel.tag=[((DropDownRowConfirm*)[tableArray objectAtIndex:[indexPath row]]).rowId integerValue];
...

{
     ...
     code=((DropDownRowConfirm*)tableArray[indexPath.row]).rowId;
    NSString *msg=((DropDownRowConfirm*)tableArray[indexPath.row]).rowMsg;
    NSString *price=((DropDownRowConfirm*)tableArray[indexPath.row]).price;
    if(price==nil)
        price=@"";
...
@implementation DropDownRowConfirm
