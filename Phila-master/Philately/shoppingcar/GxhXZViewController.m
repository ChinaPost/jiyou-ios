...
@interface GxhXZViewController ()

@end

@implementation GxhXZViewController
...
- (void)viewDidLoad {
    ...
    dataList =[service queryServiceWithKey:@"XZINFO"];
...
{
    if (self.selectXZ) {
        self.selectXZ(((ServiceEntity*)dataList[[indexPath row]]).serviceCode,((ServiceEntity*)dataList[[indexPath row]]).serviceName);
    }
